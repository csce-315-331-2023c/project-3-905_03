...
//Thanks ansi-colors, socket.io, fs, child_process
...
var password = settings.password,sconsole = settings.console
...
socket.on('openssh', function(msg){
 ...
 if(msg.type === 4){
  if(db.get("processing")){socket.emit("opensshclient",{type:4,console:0})
